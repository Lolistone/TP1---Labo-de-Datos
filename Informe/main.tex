...
Para el analisis de datos se generaron una serie de tablas utilizando consultas SQL. 

En primera instancia, se  utilizaron la cantidad de sedes, la cantidad de secciones en promedio que poseen sus sede y por último el PBI per Capta del país correspondiente al año 2022. 
